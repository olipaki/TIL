// 1번. 변수 letters에 "A", "B" 배열을 할당하고 출력한다.
//  "Z"를 추가하여 출력한 뒤,
//  다시 맨 뒤 원소를 제거하고 제거된 원소와 남은 배열을 각각 출력한다.
console.log("1번 문제");
...
// 3번. 변수 numbers2에 1, 2, 3, 4, 5 배열을 할당한다.
// 반복문을 활용해 짝수만 담은 새로운 배열 newNumbers2를 만들어 출력한다.
console.log("3번 문제");
...
// 5번. 변수 student에 name: "학생", grades: ["A", "B", "C"] 객체를 할당한다.
// 객체 내부의 grades 배열에 "D"를 추가하고 전체 객체를 출력한다.
console.log("5번 문제");
